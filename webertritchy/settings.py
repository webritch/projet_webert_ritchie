"""
Django settings for webertritchy project.
...
SECRET_KEY = 'k@(fi18t0v&-l!gu)!a^uaqn&9*9-axkh_@pjt6!u%*ci)iv8n'
...
ROOT_URLCONF = 'webertritchy.urls'

WSGI_APPLICATION = 'webertritchy.wsgi.application'
